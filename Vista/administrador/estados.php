<?php
    ...
    require_once("../../Controlador/estados/mostrarestados.php");
?>
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <form class="registroInfoEstado" method="POST" action="../../Controlador/estados/InsertarEstado.php">
                            <h1>Estados</h1>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 col-lg-6">
                                    ...
                                    <input type="text" class="form-control" required placeholder="Estado" name="nombre_est">
                                </div>
