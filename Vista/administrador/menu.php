...
<main class="d-flex flex-nowrap">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
      <li class="nav-item">
        <a href="estados.php" class="nav-link text-white" aria-current="page">
      ...
      <li>
        <a href="bodegas.php" class="nav-link text-white">
          <i class="bi bi-shop-window"></i>
          Almacenamiento de P.
        </a>
      </li>
      <li>
        <a href="facturacion.php" class="nav-link text-white">
        <i class="bi bi-cash"></i>
          Registrar Recibos
        </a>
      </li>
      <li>
        <a href="vistarRecibosVenta.php" class="nav-link text-white">
        <i class="bi bi-layout-text-sidebar-reverse"></i>
          Comprobantes de Venta
        </a>
      </li>
      <li>
        <a href="vistarRecibosCompra.php" class="nav-link text-white">
        <i class="bi bi-layout-text-sidebar-reverse"></i>
          Comprobantes de Compra
        </a>
      </li>
      <li>
        <a href="../calendario/index.php" class="nav-link text-white">
