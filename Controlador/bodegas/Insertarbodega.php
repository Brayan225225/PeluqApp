...
else
{
    ...
    $resultado = $objbodegas->insertarBodega($productos_ing,$productos_sal,$stock_min,$stock_max,$cantidad_dis,$ubicacion_pro,$id_prodcuto,$id_estado);    
}
